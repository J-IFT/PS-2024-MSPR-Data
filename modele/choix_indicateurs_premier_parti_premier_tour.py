...
def prepare_data():
    ...
    feature_columns = [
        ...
        'SUP2_total', 'SUP34_total', 'SUP5_total', 'nombre_habitants', 'nombre_immigration'
...
# Sélectionner la corrélation avec la variable cible 'premier_parti_encoded'
correlation_with_target = correlation_matrix['premier_parti_encoded']
...
plt.title('Corrélation des variables explicatives avec le parti qui a le plus de voix au premier tour :')
